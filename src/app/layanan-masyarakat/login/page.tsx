...
export default function LoginPage() {
  ...
  return (
    <main className="h-screen w-full bg-gradient-to-br from-[#0B281F] via-[#004F3B] to-[#0B281F] relative flex flex-col items-center justify-center p-0 md:p-4 overflow-hidden">
      ...
      <div className="relative z-20 w-full h-full md:h-auto max-w-full md:max-w-4xl overflow-hidden rounded-none md:rounded-3xl border-0 md:border border-white/30 bg-white/70 shadow-[0_40px_100px_rgba(0,0,0,0.12)] backdrop-blur-2xl flex flex-col md:flex-row transition-all">
        ...
        <div className="w-full md:w-1/2 p-6 sm:p-8 md:p-10 lg:p-12 flex flex-col justify-between md:justify-center bg-white/40 h-full md:h-auto overflow-y-auto md:overflow-visible">
          <div className="flex-1 flex flex-col justify-center md:flex-none">
            <div className="mb-6 sm:mb-8">
              ...
              <h3 
                className="text-2xl sm:text-3xl font-bold text-[#0B281F]"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-[11px] font-bold uppercase tracking-widest text-[#0B281F]/40 ml-1">NIK / Email</label>
                <div className="group relative">
                  ...
                  <input 
                    ...
                    className="w-full h-11 sm:h-12 rounded-xl border border-white bg-white/60 px-5 pl-12 text-[14px] font-bold text-[#0B281F] shadow-sm outline-none focus:ring-4 focus:ring-[#009966]/10 transition-all"
                    value={nik}
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between ml-1">
                  <label className="text-[11px] font-bold uppercase tracking-widest text-[#0B281F]/40">Password</label>
              ...
              <button 
                type="submit" 
                disabled={loading}
                className="group relative w-full h-11 sm:h-12 rounded-xl bg-[#0B281F] text-white font-bold shadow-xl transition-all hover:bg-[#004F3B] active:scale-[0.98] disabled:opacity-50"
              >
          ...
          <div className="mt-6 pt-6 border-t border-[#0B281F]/5 text-center">
            ...
            <Link 
              href="/"
              className="mt-4 md:hidden flex items-center justify-center gap-2 rounded-xl bg-[#0B281F]/5 border border-[#0B281F]/10 px-4 py-2.5 text-[12px] font-bold text-[#0B281F] hover:bg-[#0B281F]/10 transition-all"
            >
              <Home size={14} />
              Kembali ke Beranda
            </Link>
      ...
      {/* Back to Home Button Below the Card (Desktop only) */}
      <Link 
        href="/"
        className="mt-8 z-30 hidden md:flex items-center gap-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 px-5 py-2.5 text-[12px] font-bold text-white hover:bg-white/20 transition-all shadow-lg"
      >
        <Home size={14} />
        Kembali ke Beranda
      </Link>
      ...
      {/* Footer text */}
      <p className="mt-6 text-[10px] font-bold uppercase tracking-[0.3em] text-white/20 hidden md:block">
