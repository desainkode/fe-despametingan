...
function TableRow({ item }: { item: TableItem }) {
    ...
    return (
        <>
            <tr
                className={`transition-colors hover:bg-[#F6F8F7] ${item.isTotal ? "bg-[#F0B100]/5 font-bold" :
            ...
            >
                ...
                <td className={`px-4 py-4 text-[13px] md:px-6 ${item.level === 2 ? "pl-8" :
                ...
                <td className="px-4 py-4 text-center md:px-6">
                    <button
                        ...
                        className={`flex h-8 w-8 mx-auto items-center justify-center rounded-full transition-all ${isExpanded ? "bg-[#0B281F] text-white shadow-md" : "bg-[#0B281F]/5 text-[#0B281F] hover:bg-[#0B281F]/10"
                            }`}
                    >
