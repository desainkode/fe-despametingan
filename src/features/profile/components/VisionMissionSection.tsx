...
export function VisionMissionSection({ vision, mission }: { vision: string, mission: string[] }) {
  return (
    <section className="relative overflow-hidden rounded-[32px] bg-[#0B281F] p-8 text-white shadow-2xl sm:rounded-[48px] md:p-16 lg:p-20">
      ...
      <div className="relative z-10 grid gap-12 md:gap-16 lg:grid-cols-2">
        ...
        <div className="space-y-6 md:space-y-8">
          <div className="inline-flex items-center gap-3 rounded-full bg-white/10 px-6 py-2 text-[12px] font-bold uppercase tracking-widest text-[#00E0A1] backdrop-blur-md sm:text-[13px]">
            <Target size={18} />
            Visi Desa
          </div>
        ...
        {/* Mission */}
        <div className="space-y-6 md:space-y-8">
          <div className="inline-flex items-center gap-3 rounded-full bg-white/10 px-6 py-2 text-[12px] font-bold uppercase tracking-widest text-[#F0B100] backdrop-blur-md sm:text-[13px]">
