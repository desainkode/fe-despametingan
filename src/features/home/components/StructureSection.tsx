          ...
          <div className="hero-reveal flex flex-col gap-6">
            <div className="flex flex-col gap-6">
              <div className="inline-flex items-center gap-2 rounded-full bg-[#00D492]/10 px-4 py-1.5 border border-[#00D492]/20 w-fit">
                ...
                <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#00D492]">Perangkat Desa</span>
              </div>
              
              <h2 className="hero-reveal text-[24px] font-bold leading-[1.1] tracking-tight text-[#052119] md:text-[32px] lg:text-[36px] xl:text-[40px]">
                Struktur <br />
                <span className="text-transparent bg-clip-text bg-linear-to-r from-[#00D492] to-[#004D39]">Tata Kelola Desa</span>
              </h2>
              
              <p className="hero-reveal text-[14px] leading-relaxed text-[#052119]/70 md:text-[15px]">
            ...
            <div className="flex items-center gap-6">
              <Link
                href="/struktur"
                className="group inline-flex items-center gap-3 rounded-2xl bg-[#052119] px-8 py-4 text-[14px] font-bold text-[#00D492] shadow-xl transition-all hover:-translate-y-1 hover:shadow-2xl active:scale-95"
              >
                Seluruh Staf
                  ...
                  <div className="group relative h-[420px] w-[280px] overflow-hidden rounded-[32px] bg-[#052119] shadow-xl transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl md:h-[480px] md:w-[320px]">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-8">
                      <div className="flex flex-col">
                        <span className="mb-2 w-fit rounded-lg bg-[#00D492]/20 px-3 py-1 text-[9px] font-bold uppercase tracking-widest text-[#00D492] backdrop-blur-md">
                          {item.jabatan}
                        </span>
                        <h4 className="font-georgia text-[20px] font-bold text-white md:text-[24px]">{item.nama}</h4>
